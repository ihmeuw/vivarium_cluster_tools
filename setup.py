...
if __name__ == "__main__":
    ...
    install_requires = [
        ...
        "vivarium_build_utils[numpy,pandas,pyyaml,click,tables,loguru,pyarrow]",
        "drmaa",
        "dill",
        "redis",
        "rq",
    ...
    doc_requirements = [
        "vivarium_build_utils[sphinx,sphinx-rtd-theme,sphinx-click,sphinx-autodoc-typehints,plotting]",
    ]
